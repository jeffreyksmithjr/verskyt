...
@pytest.mark.skipif(not visualization_available, reason="Visualization dependencies not available")
class TestPlotPrototypeSpace:
    ...
    def test_invalid_reduction_method(self):
        ...
        with pytest.raises(ValueError, match="reduction_method must be 'pca' or 'tsne'"):
...
class TestVisualizePrototypesAsData:
    ...
    def create_mock_dataloader(self, num_batches=2, batch_size=4, image_shape=(1, 28, 28)):
