...
def main():
    ...
    try:
        ...
        # Default high to detect failure
        gmean_rate = analysis.get("convergence_rate_gmean_ignorematch", 1)
        ...
        validation_pass = (
            overall_rate > 0.1
            and product_rate >= overall_rate * 0.8  # Some methods should work
            and gmean_rate  # Best method should be above average
            < 0.3  # gmean should struggle
        )

        print("  Status: {}".format("✅ PASS" if validation_pass else "❌ FAIL"))
